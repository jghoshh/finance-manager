...
ROOT_URLCONF = 'finance_manager_proj.urls'
...
WSGI_APPLICATION = 'finance_manager_proj.wsgi.application'
...
AWS_SECRET_ACCESS_KEY_ID = env('AWS_SEC_KEY')
...
# url that gets prepended when static files are retrived and loaded.  
STATIC_URL = 'static/'
